    ...
    <div className="max-w-4xl mx-auto p-6 md:p-8 lg:p-12 text-gray-800 min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-gray-100">
        <div className="text-center mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 bg-gradient-to-r from-[#8d8664] to-[#306ab2] bg-clip-text text-transparent">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 border-l-4 border-[#8d8664]">
            ...
            <div className="text-base leading-relaxed text-gray-700">
              <p className="font-semibold text-xl text-[#306ab2] mb-3">
                ApexNova Bau
              </p>
              <p>Mohammad Amaren</p>
              ...
              <div className="mt-4 space-y-2">
                <p>
                  ...
                  <a
                    ...
                    className="ml-2 text-[#306ab2] hover:text-[#8d8664] transition-colors duration-300"
                  >
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <div className="bg-white/70 rounded-lg p-4">
                  <h3 className="font-semibold text-[#8d8664] mb-2">
                ...
                <div className="bg-white/70 rounded-lg p-4">
                  <h3 className="font-semibold text-[#306ab2] mb-2">
              ...
              <div className="mt-4">
                <h3 className="font-semibold text-lg mb-2 text-[#8d8664]">
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              ...
              <div className="space-y-3">
                <div className="bg-white/70 rounded-lg p-3">
                  <p>
                    <span className="font-semibold text-[#306ab2]">
                ...
                <div className="bg-white/70 rounded-lg p-3">
                  <p>
                    <span className="font-semibold text-[#8d8664]">
          ...
          <section className="bg-gradient-to-r from-purple-50 to-pink-100 rounded-xl p-6 border-l-4 border-[#306ab2]">
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              <p>
                Bei der Kontaktaufnahme mit uns (z.B. über Kontaktformular,
              ...
              <p>
                ...
                1 lit. b) DSGVO), Einwilligung (Art. 6 Abs. 1 S. 1 lit. a)
                DSGVO).
              </p>
            </div>
          </section>
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              ...
              <div className="bg-white/70 rounded-lg p-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm">
                  ...
                  <li>
                    Meta-/Kommunikationsdaten (Geräte-Informationen,
                    IP-Adressen)
                  </li>
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              <div className="bg-green-100 border-l-4 border-green-500 p-4 rounded">
                ...
                <p className="text-green-700">
                  ...
                  <span className="font-semibold">keine Cookies</span> und führt
                  <span className="font-semibold">
                    {" "}
                    kein Nutzer-Tracking
                  </span>{" "}
                  durch. Wir setzen keine Analyse-Tools wie Google Analytics,
                  Facebook Pixel oder ähnliche Dienste ein.
                </p>
              </div>
              <p>
                Dies bedeutet für Sie als Besucher maximalen Datenschutz und
                Privatsphäre beim Besuch unserer Website. Es werden keine
                Tracking-Daten gesammelt, keine Nutzerprofile erstellt und keine
                personenbezogenen Daten für Werbezwecke verarbeitet.
              </p>
            </div>
          </section>
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="bg-white/70 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Sie haben das Recht, die Einschränkung der Verarbeitung der
                ...
                <div className="bg-white/70 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    ...
                    Verarbeitung der Sie betreffenden Daten Widerspruch
                    einzulegen.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                <p className="text-sm">
                  ...
                  Sie haben zudem, unbeschadet eines anderweitigen
          ...
          <section className="bg-gradient-to-r from-rose-50 to-pink-100 rounded-xl p-6 border-l-4 border-[#306ab2]">
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              <p>
                Soweit nicht explizit angegeben, werden von uns gespeicherte
              ...
              <div className="space-y-3">
                <div className="bg-white/70 rounded-lg p-3">
                  <p>
                    ...
                    Löschung nach vollständiger Bearbeitung, spätestens nach 3
                    Jahren
                  </p>
                </div>
                <div className="bg-white/70 rounded-lg p-3">
                ...
                <div className="bg-white/70 rounded-lg p-3">
                  <p>
                    ...
                    Aufbewahrung nach handels- und steuerrechtlichen Vorgaben
                    (bis zu 10 Jahre)
                  </p>
                </div>
              </div>
              ...
              <p className="text-sm text-gray-600">
                Sofern gesetzliche Aufbewahrungspflichten bestehen (z.B. nach
                dem Handelsgesetzbuch, der Abgabenordnung oder anderen
                Gesetzen), werden die Daten entsprechend den gesetzlichen
                Vorgaben aufbewahrt.
              </p>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-r from-violet-50 to-purple-100 rounded-xl p-6 border-l-4 border-[#8d8664]">
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              ...
              <p>
                ...
                oder TLS-Verschlüsselung aktiviert ist, können die Daten, die
          ...
          <section className="bg-gradient-to-r from-amber-50 to-yellow-100 rounded-xl p-6 border-l-4 border-[#306ab2]">
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              ...
              <p>
                ...
                Datenschutzerklärung regelmäßig zu lesen, um über den Schutz der
                von uns erfassten Informationen auf dem Laufenden zu bleiben.
              </p>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-r from-slate-50 to-gray-100 rounded-xl p-6 border-l-4 border-[#8d8664]">
            ...
            <div className="text-base leading-relaxed text-gray-700 space-y-3">
              <p>
                ...
                Datenschutz verantwortliche Person in unserem Unternehmen:
              </p>
              <div className="bg-white/70 rounded-lg p-4">
                <p className="font-semibold text-[#306ab2]">
                  ApexNova Bau - Datenschutz
                </p>
                <p>Mohammad Amaren</p>
                <p>
                  <span className="font-semibold">E-Mail:</span>
          ...
          <div className="text-center pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-500 bg-gradient-to-r from-gray-100 to-gray-200 rounded-lg p-4">
              ...
              <span className="font-semibold ml-4">ApexNova Bau</span> - Ihr
              Partner für professionelle Bauarbeiten
              <br />
            </p>
          </div>
        </div>
