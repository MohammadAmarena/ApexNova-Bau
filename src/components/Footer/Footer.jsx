...
const Footer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate form submission (da kein Backend vorhanden)
    setTimeout(() => {
      alert("Nachricht erfolgreich gesendet! Wir melden uns schnellstmöglich bei Ihnen.");
  ...
  // Funktion für Navigation zu Legal-Seiten mit Scroll nach oben
  const handleLegalNavigation = () => {
    // Scroll nach oben, wenn auf Legal-Links geklickt wird
    setTimeout(() => {
      window.scrollTo({ top: 0, behavior: "smooth" });
    }, 100);
  };
        ...
        <div className="relative z-20 container mx-auto py-8 md:py-12 lg:py-16 px-4 md:px-6">
          ...
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            ...
            <p className="text-base md:text-lg lg:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed font-light px-4">
              Bereit für Ihr nächstes Bauprojekt? Kontaktieren Sie uns für eine
              kostenlose Beratung und ein unverbindliches Angebot.
            </p>
          </div>
                ...
                <div className="space-y-6 md:space-y-8">
                  ...
                  <div className="flex items-center gap-4 md:gap-6 group/item">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-white/70 text-xs md:text-sm mb-1 uppercase tracking-wider">
                        Telefon
                      </p>
                      <a
                        href="tel:+4917664329242"
                        className="text-sm md:text-lg lg:text-xl font-bold text-white hover:text-[#8d8664] transition-all duration-300 break-all"
                      >
                        +49 176 64329242
                      </a>
                    </div>
                  ...
                  <div className="flex items-center gap-4 md:gap-6 group/item">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <a
                        ...
                        className="text-sm md:text-lg lg:text-xl font-bold text-white hover:text-[#306ab2] transition-all duration-300 break-all"
                      >
                  ...
                  <div className="flex items-center gap-4 md:gap-6 group/item">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm md:text-lg lg:text-xl font-bold text-white">
                        Deutschlandweit
                      </p>
                    </div>
                  </div>
          ...
          <div className="mt-12 md:mt-16 lg:mt-20 pt-6 md:pt-8 lg:pt-12 border-t border-white/20 text-center relative">
            ...
            <p className="text-white/80 text-sm md:text-base lg:text-lg px-4 mb-4">
              © 2025 ApexNova Bau. Alle Rechte vorbehalten. |
            ...
            <div className="mt-4 space-x-4 text-sm">
              <Link 
                ...
                className="text-white/70 hover:text-[#8d8664] transition-colors duration-300 hover:underline"
              >
                Impressum
              </Link>
              ...
              <Link 
                to="/datenschutz" 
                onClick={handleLegalNavigation}
                className="text-white/70 hover:text-[#306ab2] transition-colors duration-300 hover:underline"
              >
